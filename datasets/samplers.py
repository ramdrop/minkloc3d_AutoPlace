...
class BatchSampler(Sampler):
    ...
    def __init__(self, dataset: OxfordDataset, batch_size: int, batch_size_limit: int = None, batch_expansion_rate: float = None):
        ...
        self.batch_size_limit = batch_size_limit  # 256
        self.batch_expansion_rate = batch_expansion_rate  # 1.4
    ...
    def generate_batches(self):
        ...
        unused_elements_ndx = copy.deepcopy(self.elems_ndx)     # 21711
        current_batch = []
        ...
        while True:
            ...
            current_batch += [selected_element, second_positive]  # query, positive
